...
<script type="text/javascript">
	function formValidation() {
		...
		if (re.test(phonenumber)) {
			...
			//alert("not phone..");
			e_5.textContent = "** Not a vlaid phone number!";
			e_5.style.color = "white";
		  ...
		  if( sn==1  && sp==1&&aff==1&& em==1 &&ph==1&&web==1&&pri==1  ){
			...
			<div id="addSchool_div1">
				<fieldset>
					...
					<label id="sname">Name of school:</label> <input type="text"
						name="schoolName" id="schoolName" required="required">&nbsp<span
					...
					<div id="addSchool_div6">
						...
						><br> <span id="e_5"></span><br> <label>Principal
